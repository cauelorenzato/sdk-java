...
public class NormalizedSamples {
    ...
    public static void main(String[] args) throws InvalidToken, SDKException, UnsupportedEncodingException {
         ...
         */
        JsonObject json = factory.getNormalized().listAll(username, source);
         ...
         */
        json = factory.normalized.create(username, source, "Name", "value");

        /**
         * Get the response form the API getting one normalized data
         */
        json = factory.normalized.getOne(username, source, "source-3-normalized-1");
         ...
         */
        json = factory.normalized.update(username, source, "normalized-name", "new name", "new value");
         ...
         */
        json = factory.normalized.delete(username, source, "normalized-name");
         ...
         */
        json = factory.normalized.deleteAll(username, source);
